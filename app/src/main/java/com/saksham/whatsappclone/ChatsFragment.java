...
public class ChatsFragment extends Fragment {
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Contacts, ContactsFragment.ChatsViewHolder> adapter =
                new FirebaseRecyclerAdapter<Contacts, ContactsFragment.ChatsViewHolder>(options) {
                    @Override
